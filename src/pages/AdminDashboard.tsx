      ...
      <main className="flex-1 md:ml-64 overflow-y-auto h-screen">
        ...
        <header className="bg-white border-b border-zinc-200 px-8 py-5 flex justify-between items-center sticky top-0 z-20">
           <h2 className="text-xl font-bold capitalize flex items-center gap-2">
             {activeTab} <span className="text-zinc-300 font-normal text-sm hidden sm:inline">| Hotel Sunrise Manager</span>
           </h2>
        ...
        <div className="p-8 max-w-7xl mx-auto space-y-8 pb-20">
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-zinc-200 overflow-hidden min-h-[400px]">
